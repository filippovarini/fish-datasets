...
from data_preview.visualize_kakadu import download_data, clean_annotations
import shutil
...
annotations_path = (
    settings.intermediate_dir / DATASET_SHORTNAME / settings.coco_file_name
)
...
def annotations_processing():
    ...
    shutil.move(
        str(processing_dir) + f"/JPEGImages/KakaduFishAI_boundingbox.json",
        annotations_path,
    )
