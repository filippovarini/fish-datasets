...
from data_preview.visualize_viame_fishtrack import download_data_and_build_coco_dataset, DATASET_SHORTNAME
from settings import Settings

settings = Settings()


def setup_data_paths(dataset_name):
    raw_data_path = settings.raw_dir / dataset_name
    raw_data_path.mkdir(parents=True, exist_ok=True)
    coco_dataset_path = settings.processed_dir / dataset_name
    coco_dataset_path.mkdir(parents=True, exist_ok=True)
    return raw_data_path, coco_dataset_path
...
def main():
    ...
    train_raw_data_path, train_coco_dataset_path = setup_data_paths(train_data_name)
    ...
    val_raw_data_path, val_coco_dataset_path = setup_data_paths(val_data_name)
