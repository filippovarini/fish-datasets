...
DATA_URL = "https://ftp.nmdc.no/nmdc/IMR/MachineLearning/fishDatasetSimulationAlgorithm.zip"


def download_data(download_path: Path):
    download_and_extract(download_path, DATA_URL, DATASET_SHORTNAME, CompressionType.ZIP)
