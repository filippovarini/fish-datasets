...
from data_preview.utils import build_and_visualize_supervision_dataset_from_coco_dataset, download_file
import json
import subprocess
import sys
...
if __name__ == "__main__":
    ...
    image_sample = build_and_visualize_supervision_dataset_from_coco_dataset(
        images_path, 
        annotations_path)
    plt.savefig(f"data_preview/kakadu_sample_image.png")